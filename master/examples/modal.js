...
exports.module = angular.module('app', ['gettext', ngeo_message_modalComponent_js__WEBPACK_IMPORTED_MODULE_1__["default"].name]);
...
/* harmony import */ var jquery_ui_ui_widgets_draggable_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery_ui_ui_widgets_draggable_js__WEBPACK_IMPORTED_MODULE_0__);
...
var exports = angular.module('ngeoModal', []);
exports.component_ = {
...
exports.Controller_ = function () {
  _class.$inject = ["$scope", "$element"];

  function _class($scope, $element) {
  ...
  _proto.$onInit = function $onInit() {
    ...
    this.modal_.on('shown.bs.modal hidden.bs.modal', function (e) {
      var type = e.type;
      goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__["default"].assert(type == 'shown' || type == 'hidden');
