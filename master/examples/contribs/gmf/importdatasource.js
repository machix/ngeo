...
exports.module = angular.module('gmfapp', ['gettext', gmf_datasource_Manager_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name, gmf_import_importdatasourceComponent_js__WEBPACK_IMPORTED_MODULE_4__["default"].name, gmf_layertree_component_js__WEBPACK_IMPORTED_MODULE_5__["default"].name, gmf_layertree_TreeManager_js__WEBPACK_IMPORTED_MODULE_6__["default"].module.name, gmf_map_component_js__WEBPACK_IMPORTED_MODULE_7__["default"].name, gmf_theme_Themes_js__WEBPACK_IMPORTED_MODULE_8__["default"].module.name, ngeo_datasource_DataSources_js__WEBPACK_IMPORTED_MODULE_9__["default"].module.name, ngeo_query_bboxQueryComponent_js__WEBPACK_IMPORTED_MODULE_10__["default"].name, ngeo_query_mapQueryComponent_js__WEBPACK_IMPORTED_MODULE_11__["default"].name]);
...
exports.MainController = function () {
  _class.$inject = ["$scope", "gmfDataSourcesManager", "gmfThemes", "gmfTreeManager", "ngeoDataSources"];

  function _class($scope, gmfDataSourcesManager, gmfThemes, gmfTreeManager, ngeoDataSources) {
    var _this = this;
