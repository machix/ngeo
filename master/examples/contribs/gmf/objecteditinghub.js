...
/* harmony import */ var goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! goog/asserts.js */ "./src/goog.asserts.js");
...
exports.module = angular.module('gmfapp', ['gettext', gmf_editing_XSDAttributes_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name, gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].module.name, gmf_theme_Themes_js__WEBPACK_IMPORTED_MODULE_5__["default"].module.name]);
...
exports.MainController = function ($http, $q, $scope, gmfThemes, gmfXSDAttributes) {
  ...
  this.gmfThemes_.getOgcServersObject().then(function (ogcServers) {
    ...
    _this.gmfThemes_.getThemesObject().then(function (themes) {
      ...
      goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__["default"].assert(groupNode.ogcServer);
...
exports.MainController.$inject = ["$http", "$q", "$scope", "gmfThemes", "gmfXSDAttributes"];
...
exports.MainController.prototype.runEditor = function () {
  ...
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__["default"].assert(property !== undefined);
  var id = feature.get(property);
  var params = {};
  params[gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].Param.GEOM_TYPE] = geomType;
  params[gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].Param.ID] = id;
  params[gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].Param.LAYER] = layer;
  params[gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].Param.THEME] = this.themeName;
  params[gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].Param.PROPERTY] = property;
  var url = exports.MainController.appendParams(this.selectedUrl['url'], params);
  window.open(url);
};
...
exports.MainController.prototype.runViewer_ = function (baseUrl) {
  ...
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__["default"].assert(nodeIdAttrFieldName !== undefined);
  var ids = [];
  ...
  var url = exports.MainController.appendParams(baseUrl, params);
  window.open(url);
};
...
exports.MainController.prototype.issueGetFeatures_ = function (gmfLayerNode) {
  ...
  var url = exports.MainController.appendParams(this.gmfServer_.urlWfs, {
    'SERVICE': 'WFS',
    'REQUEST': 'GetFeature',
    'VERSION': '1.1.0',
...
exports.MainController.prototype.issueGetAttributesRequest_ = function (gmfLayerNode) {
  this.gmfXSDAttributes_.getAttributes(gmfLayerNode.id).then(function (gmfLayerNode, attributes) {
    var geomAttr = ngeo_format_XSDAttribute_js__WEBPACK_IMPORTED_MODULE_7__["default"].getGeometryAttribute(attributes);
...
exports.MainController.prototype.getGeometryTypeFromCache_ = function (gmfLayerNode) {
  var id = gmfLayerNode.id;
