...
exports.module = angular.module('gmfapp', ['gettext', gmf_layertree_component_js__WEBPACK_IMPORTED_MODULE_2__["default"].name, gmf_layertree_TreeManager_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name, gmf_map_component_js__WEBPACK_IMPORTED_MODULE_4__["default"].name, gmf_objectediting_component_js__WEBPACK_IMPORTED_MODULE_5__["default"].name, gmf_objectediting_Manager_js__WEBPACK_IMPORTED_MODULE_6__["default"].module.name, gmf_theme_Themes_js__WEBPACK_IMPORTED_MODULE_7__["default"].module.name, ngeo_misc_ToolActivateMgr_js__WEBPACK_IMPORTED_MODULE_9__["default"].module.name]);
exports.module.constant('defaultTheme', 'ObjectEditing');
exports.module.constant('gmfLayersUrl', _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].GMF_LAYERS);
...
exports.MainController = function (gmfObjectEditingManager, gmfThemes, gmfTreeManager, ngeoToolActivateMgr) {
  var _this = this;

  this.gmfTreeManager_ = gmfTreeManager;
  gmfThemes.loadThemes();
  var projection = ol_proj_js__WEBPACK_IMPORTED_MODULE_11__["get"](_geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_10__["default"]);
...
exports.MainController.$inject = ["gmfObjectEditingManager", "gmfThemes", "gmfTreeManager", "ngeoToolActivateMgr"];
