...
/* harmony import */ var _mapfishprint_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mapfishprint.css */ "./examples/mapfishprint.css");
/* harmony import */ var _mapfishprint_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_mapfishprint_css__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var ol_format_GeoJSON_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ol/format/GeoJSON.js */ "./node_modules/ol/format/GeoJSON.js");
...
var appmodule = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_12__["default"].name, ngeo_print_Service_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name, ngeo_print_Utils_js__WEBPACK_IMPORTED_MODULE_4__["default"].module.name]);
exports.PRINT_SCALES_ = [100, 250, 500, 2500, 5000, 10000, 25000, 50000, 100000, 500000];
...
exports.MainController = function ($timeout, ngeoCreatePrint, ngeoPrintUtils) {
  this.map = new ol_Map_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
    layers: [new ol_layer_Image_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
      ...
      source: new ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_11__["default"]({
        ...
        format: new ol_format_GeoJSON_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
          defaultDataProjection: _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_2__["default"]
        })
      })
    })],
  ...
  this.print_ = ngeoCreatePrint(_url_js__WEBPACK_IMPORTED_MODULE_0__["default"].PRINT_PROXY);
  this.printUtils_ = ngeoPrintUtils;
  var postcomposeListener = ngeoPrintUtils.createPrintMaskPostcompose(function () {
    return exports.PRINT_PAPER_SIZE_;
  }, function (frameState) {
    var mapSize = frameState.size;
    var mapResolution = frameState.viewState.resolution;
    return mapSize !== undefined && mapResolution !== undefined ? ngeoPrintUtils.getOptimalScale(mapSize, mapResolution, exports.PRINT_PAPER_SIZE_, exports.PRINT_SCALES_) : exports.PRINT_SCALES_[0];
  });
  this.map.on('postcompose', postcomposeListener);
};

exports.MainController.$inject = ["$timeout", "ngeoCreatePrint", "ngeoPrintUtils"];

exports.MainController.prototype.print = function () {
  var map = this.map;
  var mapSize = map.getSize();
  var viewResolution = map.getView().getResolution();
  var scale = mapSize !== undefined && viewResolution !== undefined ? this.printUtils_.getOptimalScale(mapSize, viewResolution, exports.PRINT_PAPER_SIZE_, exports.PRINT_SCALES_) : exports.PRINT_SCALES_[0];
  var dpi = exports.PRINT_DPI_;
  var format = exports.PRINT_FORMAT_;
  var layout = exports.PRINT_LAYOUT_;
