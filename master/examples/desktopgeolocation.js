...
/* harmony import */ var ngeo_geolocation_desktop_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngeo/geolocation/desktop.js */ "./src/geolocation/desktop.js");
var exports = {};
...
exports.module = angular.module('app', ['gettext', ngeo_geolocation_desktop_js__WEBPACK_IMPORTED_MODULE_10__["default"].name, ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_9__["default"].name]);
...
var exports = angular.module('ngeoDesktopGeolocation', [ngeo_map_FeatureOverlayMgr_js__WEBPACK_IMPORTED_MODULE_1__["default"].module.name, ngeo_message_Notification_js__WEBPACK_IMPORTED_MODULE_2__["default"].module.name]);
...
exports.Controller_ = function ($scope, $element, ngeoFeatureOverlayMgr, ngeoNotification) {
  var _this = this;

  $element.on('click', this.toggle.bind(this));
  var map = $scope['getDesktopMapFn']();
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assertInstanceof(map, ol_Map_js__WEBPACK_IMPORTED_MODULE_6__["default"]);
  this.map_ = map;
  ...
  ol_events_js__WEBPACK_IMPORTED_MODULE_3__["listen"](this.geolocation_, 'change:position', function (event) {
    _this.setPosition_(event);
  });
};

exports.Controller_.$inject = ["$scope", "$element", "ngeoFeatureOverlayMgr", "ngeoNotification"];
...
exports.controller('ngeoGeolocationDesktopController', exports.Controller_);
/* harmony default export */ __webpack_exports__["default"] = (exports);
