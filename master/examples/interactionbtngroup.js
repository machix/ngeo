...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_1__["default"].name, ngeo_misc_btnComponent_js__WEBPACK_IMPORTED_MODULE_2__["default"].name]);

exports.MainController = function (ngeoFeatureOverlayMgr) {
  var features = new ol_Collection_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  var overlay = ngeoFeatureOverlayMgr.getFeatureOverlay();
  overlay.setFeatures(features);
  overlay.setStyle(new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_13__["default"]({
  ...
  this.drawPolygon = new ol_interaction_Draw_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
    type: 'Polygon',
    features: features
  });
  var drawPolygon = this.drawPolygon;
  drawPolygon.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_3__["default"].interaction(drawPolygon);
  map.addInteraction(drawPolygon);
  this.drawPoint = new ol_interaction_Draw_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
    type: 'Point',
    features: features
  });
  var drawPoint = this.drawPoint;
  drawPoint.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_3__["default"].interaction(drawPoint);
  map.addInteraction(drawPoint);
  this.drawLine = new ol_interaction_Draw_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
    type: 'LineString',
    features: features
  });
  var drawLine = this.drawLine;
  drawLine.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_3__["default"].interaction(drawLine);
  map.addInteraction(drawLine);
};

exports.MainController.$inject = ["ngeoFeatureOverlayMgr"];
