...
/* harmony import */ var _locationsearch_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./locationsearch.css */ "./examples/locationsearch.css");
...
var appmodule = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_2__["default"].name, ngeo_search_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name]);
...
exports.SearchController.$inject = ["ngeoCreateLocationSearchBloodhound"];
...
exports.SearchController.prototype.createAndInitBloodhound_ = function (ngeoCreateLocationSearchBloodhound, limit) {
  ...
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_1__["default"].assert(epsg3857 !== null);
...
exports.SearchController.select_ = function (event, suggestion, dataset) {
  ...
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_1__["default"].assert(size !== undefined);
  var maxZoom = 16;
