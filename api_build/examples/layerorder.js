...
/* harmony import */ var ngeo_misc_sortableComponent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngeo/misc/sortableComponent.js */ "./src/misc/sortableComponent.js");
/* harmony import */ var ngeo_misc_syncArrays_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngeo/misc/syncArrays.js */ "./src/misc/syncArrays.js");
/* harmony import */ var ngeo_source_AsitVD_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngeo/source/AsitVD.js */ "./src/source/AsitVD.js");
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_1__["default"].name, ngeo_misc_sortableComponent_js__WEBPACK_IMPORTED_MODULE_2__["default"].name]);

exports.MainController = function ($scope) {
  var asitvd = new ol_layer_Tile_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    source: new ngeo_source_AsitVD_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      layer: 'asitvd.fond_couleur'
    })
  });
  asitvd.set('name', 'asitvd');
  var boundaries = new ol_layer_Tile_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    source: new ol_source_TileWMS_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
  ...
  var waterBodies = new ol_layer_Tile_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    source: new ol_source_TileWMS_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
      url: 'https://wms.geo.admin.ch',
      params: {
  ...
  var cities = new ol_layer_Tile_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    source: new ol_source_TileWMS_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
      url: 'https://wms.geo.admin.ch',
      params: {
  ...
  var map = this.map;
  this.roads_ = new ol_layer_Tile_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
    source: new ol_source_TileWMS_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
      url: 'https://wms.geo.admin.ch',
      params: {
  ...
  Object(ngeo_misc_syncArrays_js__WEBPACK_IMPORTED_MODULE_3__["default"])(map.getLayers().getArray(), selectedLayers, true, $scope, layerFilter);
...
var exports = function exports(arr1, arr2, reverse, scope, filter) {
  ...
  var dereg2 = scope.$watchCollection(function () {
    ...
    if (reverse) {
      ...
      goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(j == -1);
    } else {
      for (i = 0, ii = arr1.length, j = 0; i < ii; ++i) {
        if (filter(arr1[i])) {
          arr1[i] = arr2[j++];
      ...
      goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(j == arr2.length);
    }
  });
  return function () {
    dereg1();
