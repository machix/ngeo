...
exports.module = angular.module('app', ['gettext', ngeo_message_Popup_js__WEBPACK_IMPORTED_MODULE_2__["default"].module.name]);
...
exports.MainController.$inject = ["$sce", "ngeoCreatePopup"];
