...
exports.module = angular.module('app', ['gettext', ngeo_message_Notification_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name]);
...
exports.MainController.$inject = ["ngeoNotification"];

exports.MainController.prototype.notifyMulti = function () {
  this.notification.notify([{
    msg: ['Error #', this.i_++].join(''),
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_2__["default"].Type.ERROR
  }, {
    msg: ['Warning #', this.i_++].join(''),
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_2__["default"].Type.WARNING
  }, {
    msg: ['Information #', this.i_++].join(''),
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_2__["default"].Type.INFORMATION
  }, {
    msg: ['Success #', this.i_++].join(''),
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_2__["default"].Type.SUCCESS
  }]);
};
