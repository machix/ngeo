...
/* harmony import */ var _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @geoblocks/proj/src/EPSG_21781.js */ "./node_modules/@geoblocks/proj/src/EPSG_21781.js");
...
/* harmony import */ var ngeo_profile_elevationComponent_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngeo/profile/elevationComponent.js */ "./src/profile/elevationComponent.js");
var exports = {};
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_11__["default"].name, ngeo_profile_elevationComponent_js__WEBPACK_IMPORTED_MODULE_12__["default"].name]);

exports.MainController = function ($http, $scope) {
  var _this = this;

  this.scope_ = $scope;
  var source = new ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
  this.map = new ol_Map_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
    layers: [new ol_layer_Image_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
      source: new ol_source_ImageWMS_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
    ...
    view: new ol_View_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      projection: _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  $http.get('data/profile.json').then(function (resp) {
    ...
    var i;
    var len = data.length;
    var lineString = new ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_5__["default"]([], 'XYM');
    ...
    source.addFeature(new ol_Feature_js__WEBPACK_IMPORTED_MODULE_2__["default"](lineString));
  ...
  var hoverCallback = function (point) {
    this.point = point;
    this.snappedPoint_.setGeometry(new ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_6__["default"]([point.x, point.y]));
  }.bind(this);
...
exports.MainController.$inject = ["$http", "$scope"];
