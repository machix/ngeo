...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _drawfeature_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./drawfeature.css */ "./contribs/gmf/examples/drawfeature.css");
...
/* harmony import */ var gmf_drawing_module_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gmf/drawing/module.js */ "./contribs/gmf/src/drawing/module.js");
...
exports.module = angular.module('gmfapp', ['gettext', gmf_drawing_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name, gmf_map_component_js__WEBPACK_IMPORTED_MODULE_2__["default"].name, ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_6__["default"].name, ngeo_misc_FeatureHelper_js__WEBPACK_IMPORTED_MODULE_7__["default"].module.name, ngeo_misc_ToolActivateMgr_js__WEBPACK_IMPORTED_MODULE_9__["default"].module.name]);
exports.module.value('ngeoExportFeatureFormats', [ngeo_misc_FeatureHelper_js__WEBPACK_IMPORTED_MODULE_7__["default"].FormatType.KML, ngeo_misc_FeatureHelper_js__WEBPACK_IMPORTED_MODULE_7__["default"].FormatType.GPX]);
exports.module.constant('defaultTheme', 'Demo');
exports.module.constant('angularLocaleScript', '../build/angular-locale_{{locale}}.js');

exports.MainController = function ($scope, ngeoFeatureHelper, ngeoFeatures, ngeoToolActivateMgr, ngeoFeatureOverlayMgr) {
  var _this = this;
  ...
  ngeoFeatureHelper.setProjection(goog_asserts_js__WEBPACK_IMPORTED_MODULE_4__["default"].assert(view.getProjection()));
  ...
  $scope.$watch(function () {
    ...
    if (newVal) {
      _this.map.on('pointermove', _this.handleMapPointerMove_, _this);
    } else {
      _this.map.un('pointermove', _this.handleMapPointerMove_, _this);
...
exports.MainController.$inject = ["$scope", "ngeoFeatureHelper", "ngeoFeatures", "ngeoToolActivateMgr", "ngeoFeatureOverlayMgr"];
