...
/* harmony import */ var _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @geoblocks/proj/src/EPSG_21781.js */ "./node_modules/@geoblocks/proj/src/EPSG_21781.js");
...
exports.module = angular.module('gmfapp', ['gettext', gmf_authentication_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name, gmf_datasource_Manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].module.name, gmf_layertree_component_js__WEBPACK_IMPORTED_MODULE_6__["default"].name, gmf_layertree_TreeManager_js__WEBPACK_IMPORTED_MODULE_7__["default"].module.name, gmf_filters_module_js__WEBPACK_IMPORTED_MODULE_5__["default"].name, gmf_map_component_js__WEBPACK_IMPORTED_MODULE_8__["default"].name, gmf_theme_Themes_js__WEBPACK_IMPORTED_MODULE_9__["default"].module.name, ngeo_datasource_DataSources_js__WEBPACK_IMPORTED_MODULE_10__["default"].module.name, ngeo_misc_ToolActivateMgr_js__WEBPACK_IMPORTED_MODULE_14__["default"].module.name, ngeo_query_bboxQueryComponent_js__WEBPACK_IMPORTED_MODULE_11__["default"].name, ngeo_query_mapQueryComponent_js__WEBPACK_IMPORTED_MODULE_12__["default"].name]);
...
exports.MainController = function () {
  _class.$inject = ["$scope", "gmfDataSourcesManager", "gmfThemes", "gmfTreeManager", "ngeoDataSources", "ngeoToolActivateMgr"];

  function _class($scope, gmfDataSourcesManager, gmfThemes, gmfTreeManager, ngeoDataSources, ngeoToolActivateMgr) {
    var _this = this;
    ...
    this.map = new ol_Map_js__WEBPACK_IMPORTED_MODULE_16__["default"]({
      ...
      view: new ol_View_js__WEBPACK_IMPORTED_MODULE_17__["default"]({
        projection: _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_15__["default"],
    ...
    var filterSelectorToolActivate = new ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_13__["default"](this, 'filterSelectorActive');
    ngeoToolActivateMgr.registerTool('dummyTools', filterSelectorToolActivate, true);
    this.dummyActive = false;
    var dummyToolActivate = new ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_13__["default"](this, 'dummyActive');
    ngeoToolActivateMgr.registerTool('dummyTools', dummyToolActivate, false);
    this.queryActive = true;
    var queryToolActivate = new ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_13__["default"](this, 'queryActive');
