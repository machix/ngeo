...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./url.js */ "./contribs/gmf/examples/url.js");
...
/* harmony import */ var gmf_editing_editFeatureSelectorComponent_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! gmf/editing/editFeatureSelectorComponent.js */ "./contribs/gmf/src/editing/editFeatureSelectorComponent.js");
...
/* harmony import */ var ngeo_misc_FeatureHelper_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngeo/misc/FeatureHelper.js */ "./src/misc/FeatureHelper.js");
/* harmony import */ var ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngeo/misc/ToolActivate.js */ "./src/misc/ToolActivate.js");
/* harmony import */ var ngeo_misc_ToolActivateMgr_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngeo/misc/ToolActivateMgr.js */ "./src/misc/ToolActivateMgr.js");
...
exports.module = angular.module('gmfapp', ['gettext', gmf_authentication_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name, gmf_editing_editFeatureSelectorComponent_js__WEBPACK_IMPORTED_MODULE_4__["default"].name, gmf_layertree_component_js__WEBPACK_IMPORTED_MODULE_5__["default"].name, gmf_layertree_TreeManager_js__WEBPACK_IMPORTED_MODULE_6__["default"].module.name, gmf_map_component_js__WEBPACK_IMPORTED_MODULE_7__["default"].name, gmf_theme_Themes_js__WEBPACK_IMPORTED_MODULE_8__["default"].module.name, ngeo_misc_FeatureHelper_js__WEBPACK_IMPORTED_MODULE_9__["default"].module.name, ngeo_misc_ToolActivateMgr_js__WEBPACK_IMPORTED_MODULE_11__["default"].module.name]);
exports.module.value('gmfTreeUrl', _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].GMF_THEMES);
exports.module.value('authenticationBaseUrl', _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].GMF_DEMO);
...
exports.MainController = function ($scope, gmfThemes, gmfTreeManager, gmfUser, ngeoFeatureHelper, ngeoToolActivateMgr) {
  var _this = this;
  ...
  this.vectorLayer = new ol_layer_Vector_js__WEBPACK_IMPORTED_MODULE_17__["default"]({
    source: new ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_19__["default"]({
      wrapX: false,
      features: new ol_Collection_js__WEBPACK_IMPORTED_MODULE_13__["default"]()
    }),
  ...
  var editFeatureSelectorToolActivate = new ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_10__["default"](this, 'editFeatureSelectorActive');
  ngeoToolActivateMgr.registerTool('mapTools', editFeatureSelectorToolActivate, true);
  this.dummyActive = false;
  var dummyToolActivate = new ngeo_misc_ToolActivate_js__WEBPACK_IMPORTED_MODULE_10__["default"](this, 'dummyActive');
...
exports.MainController.$inject = ["$scope", "gmfThemes", "gmfTreeManager", "gmfUser", "ngeoFeatureHelper", "ngeoToolActivateMgr"];
