...
/* harmony import */ var _search_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./search.css */ "./examples/search.css");
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name, ngeo_search_module_js__WEBPACK_IMPORTED_MODULE_5__["default"].name]);
...
exports.SearchController.$inject = ["$element", "$rootScope", "$compile", "ngeoSearchCreateGeoJSONBloodhound"];
...
exports.SearchController.prototype.createAndInitBloodhound_ = function (ngeoSearchCreateGeoJSONBloodhound) {
  var url = _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].SEARCH;
  var bloodhound = ngeoSearchCreateGeoJSONBloodhound(url, undefined, ol_proj_js__WEBPACK_IMPORTED_MODULE_10__["get"]('EPSG:3857'), _geoblocks_proj_src_EPSG_21781_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
exports.SearchController.select_ = function (event, suggestion, dataset) {
  ...
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_2__["default"].assert(size !== undefined);
