...
/* harmony import */ var ngeo_interaction_MeasureArea_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngeo/interaction/MeasureArea.js */ "./src/interaction/MeasureArea.js");
/* harmony import */ var ngeo_interaction_MeasureAzimut_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngeo/interaction/MeasureAzimut.js */ "./src/interaction/MeasureAzimut.js");
/* harmony import */ var ngeo_interaction_MeasureLength_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngeo/interaction/MeasureLength.js */ "./src/interaction/MeasureLength.js");
...
/* harmony import */ var ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngeo/misc/decorate.js */ "./src/misc/decorate.js");
/* harmony import */ var ngeo_misc_filters_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngeo/misc/filters.js */ "./src/misc/filters.js");
...
/* harmony import */ var angular_sanitize__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! angular-sanitize */ "./node_modules/angular-sanitize/index.js");
/* harmony import */ var angular_sanitize__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(angular_sanitize__WEBPACK_IMPORTED_MODULE_17__);
var exports = {};
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_4__["default"].name, ngeo_misc_btnComponent_js__WEBPACK_IMPORTED_MODULE_5__["default"].name, ngeo_misc_filters_js__WEBPACK_IMPORTED_MODULE_7__["default"].name, 'ngSanitize']);
...
exports.MeasuretoolsController = function ($scope, $compile, $sce, $filter, gettextCatalog) {
  var _this = this;
  ...
  var measureStartMsg = angular.element('<span ng-bind-html="ctrl.measureStartMsg"></span>');
  measureStartMsg = $compile(measureStartMsg)($scope);
  var measureLengthContinueMsg = angular.element('<span ng-bind-html="ctrl.measureLengthContinueMsg"></span>');
  measureLengthContinueMsg = $compile(measureLengthContinueMsg)($scope);
  var measureAreaContinueMsg = angular.element('<span ng-bind-html="ctrl.measureAreaContinueMsg"></span>');
  measureAreaContinueMsg = $compile(measureAreaContinueMsg)($scope);
  var measureAzimutContinueMsg = angular.element('<span ng-bind-html="ctrl.measureAzimutContinueMsg"></span>');
  ...
  var style = new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_13__["default"]({
    fill: new ol_style_Fill_js__WEBPACK_IMPORTED_MODULE_16__["default"]({
  ...
  this.measureLength = new ngeo_interaction_MeasureLength_js__WEBPACK_IMPORTED_MODULE_3__["default"]($filter('ngeoUnitPrefix'), gettextCatalog, {
    sketchStyle: style,
    startMsg: measureStartMsg[0],
    continueMsg: measureLengthContinueMsg[0]
  });
  this.measureLength.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_6__["default"].interaction(this.measureLength);
  this.measureArea = new ngeo_interaction_MeasureArea_js__WEBPACK_IMPORTED_MODULE_1__["default"]($filter('ngeoUnitPrefix'), gettextCatalog, {
    sketchStyle: style,
    startMsg: measureStartMsg[0],
    continueMsg: measureAreaContinueMsg[0]
  });
  this.measureArea.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_6__["default"].interaction(this.measureArea);
  this.measureAzimut = new ngeo_interaction_MeasureAzimut_js__WEBPACK_IMPORTED_MODULE_2__["default"]($filter('ngeoUnitPrefix'), $filter('ngeoNumber'), {
    sketchStyle: style,
    startMsg: measureStartMsg[0],
    continueMsg: measureAzimutContinueMsg[0]
  });
  this.measureAzimut.setActive(false);
  ngeo_misc_decorate_js__WEBPACK_IMPORTED_MODULE_6__["default"].interaction(this.measureAzimut);
...
exports.MeasuretoolsController.$inject = ["$scope", "$compile", "$sce", "$filter", "gettextCatalog"];
