...
/* harmony import */ var ngeo_routing_module_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngeo/routing/module.js */ "./src/routing/module.js");
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_4__["default"].name, ngeo_routing_module_js__WEBPACK_IMPORTED_MODULE_5__["default"].name]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ngeo_search_searchDirective_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngeo/search/searchDirective.js */ "./src/search/searchDirective.js");
...
exports.module = angular.module('ngeoRoutingNominatimInputComponent', [ngeo_search_searchDirective_js__WEBPACK_IMPORTED_MODULE_0__["default"].module.name, ngeo_routing_NominatimService_js__WEBPACK_IMPORTED_MODULE_1__["default"].module.name]);
...
exports.module.value('ngeoRoutingNominatimInputComponentTemplateUrl', function ($attrs) {
...
exports.Controller.$inject = ["$element", "$injector", "$scope", "ngeoNominatimService"];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ngeo_misc_debounce_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngeo/misc/debounce.js */ "./src/misc/debounce.js");


var exports = function exports($http, $injector, ngeoDebounce) {
  this.$http_ = $http;
...
exports.$inject = ["$http", "$injector", "ngeoDebounce"];
exports.$inject = ["$http", "$injector", "ngeoDebounce"];
...
exports.module = angular.module('ngeoNominatimService', [ngeo_misc_debounce_js__WEBPACK_IMPORTED_MODULE_0__["default"].name]);
...
/* harmony import */ var ngeo_routing_RoutingService_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngeo/routing/RoutingService.js */ "./src/routing/RoutingService.js");
/* harmony import */ var ngeo_routing_RoutingFeatureComponent_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngeo/routing/RoutingFeatureComponent.js */ "./src/routing/RoutingFeatureComponent.js");
...
/* harmony import */ var ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ol/geom/LineString.js */ "./node_modules/ol/geom/LineString.js");
/* harmony import */ var ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngeo/sass/font.scss */ "./src/sass/font.scss");
/* harmony import */ var ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14__);
var exports = {};
...
exports.module = angular.module('ngeoRoutingComponent', [ngeo_misc_debounce_js__WEBPACK_IMPORTED_MODULE_0__["default"].name, ngeo_misc_filters_js__WEBPACK_IMPORTED_MODULE_1__["default"].name, ngeo_routing_NominatimService_js__WEBPACK_IMPORTED_MODULE_2__["default"].module.name, ngeo_routing_RoutingService_js__WEBPACK_IMPORTED_MODULE_3__["default"].module.name, ngeo_routing_RoutingFeatureComponent_js__WEBPACK_IMPORTED_MODULE_4__["default"].module.name]);
exports.module.run(["$templateCache", function ($templateCache) {
  $templateCache.put('ngeo/routing/routing', __webpack_require__(/*! ./routing.html */ "./src/routing/routing.html"));
}]);
exports.module.value('ngeoRoutingTemplateUrl', function ($attrs) {
...
exports.Controller = function ($injector, $scope, ngeoRoutingService, ngeoNominatimService, $q, ngeoDebounce) {
  ...
  this.routeSource_ = new ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
    features: []
  });
  this.routeLayer_ = new ol_layer_Vector_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
...
exports.Controller.$inject = ["$injector", "$scope", "ngeoRoutingService", "ngeoNominatimService", "$q", "ngeoDebounce"];
...
exports.Controller.prototype.getLonLatFromPoint_ = function (point) {
  ...
  return ol_proj_js__WEBPACK_IMPORTED_MODULE_11__["toLonLat"](coords, projection);
};
...
exports.Controller.prototype.parseRoute_ = function (route) {
  var parsedRoutes = [];
  var format = new ol_format_GeoJSON_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  var formatConfig = {
  ...
  if (route.legs) {
    ...
    parsedRoutes = route.legs.map(function (leg) {
      return leg.steps.map(function (step) {
        return new ol_Feature_js__WEBPACK_IMPORTED_MODULE_12__["default"]({
    ...
    parsedRoutes.push(new ol_Feature_js__WEBPACK_IMPORTED_MODULE_12__["default"]({
...
exports.Controller.prototype.calculateRoute = function () {
  ...
  if (this.startFeature_ && this.targetFeature_) {
    ...
    var onSuccess_ = function (resp) {
      ...
      var routeConnections = [new ol_Feature_js__WEBPACK_IMPORTED_MODULE_12__["default"](new ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_13__["default"](startToRoute)), new ol_Feature_js__WEBPACK_IMPORTED_MODULE_12__["default"](new ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_13__["default"](routeToEnd))];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ngeo_routing_NominatimService_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngeo/routing/NominatimService.js */ "./src/routing/NominatimService.js");
/* harmony import */ var ngeo_routing_NominatimInputComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngeo/routing/NominatimInputComponent.js */ "./src/routing/NominatimInputComponent.js");
...
/* harmony import */ var ol_style_Text_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ol/style/Text.js */ "./node_modules/ol/style/Text.js");
/* harmony import */ var ol_style_Fill_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ol/style/Fill.js */ "./node_modules/ol/style/Fill.js");
/* harmony import */ var ol_style_Stroke_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ol/style/Stroke.js */ "./node_modules/ol/style/Stroke.js");
...
/* harmony import */ var ol_interaction_Modify_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ol/interaction/Modify.js */ "./node_modules/ol/interaction/Modify.js");
/* harmony import */ var ol_interaction_Draw_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ol/interaction/Draw.js */ "./node_modules/ol/interaction/Draw.js");
/* harmony import */ var ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngeo/sass/font.scss */ "./src/sass/font.scss");
/* harmony import */ var ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(ngeo_sass_font_scss__WEBPACK_IMPORTED_MODULE_14__);
var exports = {};
...
exports.module = angular.module('ngeoRoutingFeatureComponent', [ngeo_routing_NominatimService_js__WEBPACK_IMPORTED_MODULE_0__["default"].module.name, ngeo_routing_NominatimInputComponent_js__WEBPACK_IMPORTED_MODULE_1__["default"].module.name]);
exports.module.run(["$templateCache", function ($templateCache) {
  $templateCache.put('ngeo/routing/routingfeature', __webpack_require__(/*! ./routingfeature.html */ "./src/routing/routingfeature.html"));
}]);
exports.module.value('ngeoRoutingFeatureTemplateUrl', function ($attrs) {
...
exports.Controller = function ($scope, $timeout, $q, ngeoNominatimService) {
  ...
  this.strokeColor;
  this.onChange;
  this.vectorFeatures_ = new ol_Collection_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  this.vectorSource_ = new ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
    features: this.vectorFeatures_
  });
  this.vectorLayer_ = new ol_layer_Vector_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
    source: this.vectorSource_,
    style: function (feature, resolution) {
      return [new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
        text: new ol_style_Text_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
          fill: new ol_style_Fill_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
  ...
  this.modifyFeature_ = new ol_interaction_Modify_js__WEBPACK_IMPORTED_MODULE_12__["default"]({
    features: this.vectorFeatures_
  });
  this.draw_ = null;
...
exports.Controller.$inject = ["$scope", "$timeout", "$q", "ngeoNominatimService"];
...
exports.Controller.prototype.set = function () {
  ...
  this.draw_ = new ol_interaction_Draw_js__WEBPACK_IMPORTED_MODULE_13__["default"]({
    features: this.vectorFeatures_,
    type: 'Point'
  });
...
exports.Controller.prototype.setFeature_ = function (coordinate, label) {
  var transformedCoordinate = ol_proj_js__WEBPACK_IMPORTED_MODULE_2__["fromLonLat"](coordinate, this.map.getView().getProjection());
  ...
  this.feature = new ol_Feature_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
    geometry: new ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_11__["default"](transformedCoordinate),
    name: label
  });
};
...
exports.Controller.prototype.getLonLatFromPoint_ = function (point) {
  ...
  var coords = geometry.getCoordinates();
  var projection = this.map.getView().getProjection();
  return ol_proj_js__WEBPACK_IMPORTED_MODULE_2__["toLonLat"](coords, projection);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var exports = function exports($http, $injector) {
  this.$http_ = $http;
  this.routingOptions_ = $injector.has('ngeoRoutingOptions') ? $injector.get('ngeoRoutingOptions') : {};
...
/* harmony default export */ __webpack_exports__["default"] = (angular__WEBPACK_IMPORTED_MODULE_0__["module"]('ngeoRoutingModule', [ngeo_routing_RoutingComponent_js__WEBPACK_IMPORTED_MODULE_1__["default"].module.name]));
