...
/* harmony import */ var ngeo_olcs_olcsModule_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngeo/olcs/olcsModule.js */ "./src/olcs/olcsModule.js");
...
/* harmony import */ var ngeo_olcs_Manager_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngeo/olcs/Manager.js */ "./src/olcs/Manager.js");
var exports = {};
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_6__["default"].name, ngeo_olcs_olcsModule_js__WEBPACK_IMPORTED_MODULE_5__["default"].name]);
...
exports.MainController = function ($rootScope, ngeoOlcsService) {
  ...
  this.ol3dm = new ngeo_olcs_Manager_js__WEBPACK_IMPORTED_MODULE_7__["default"](cesiumUrl, $rootScope, {
    map: this.map
  });
  ngeoOlcsService.initialize(this.ol3dm);
};

exports.MainController.$inject = ["$rootScope", "ngeoOlcsService"];
...
var Service = function () {
  Service.$inject = ["ngeoDebounce", "ngeoLocation", "ngeoStateManager"];

  function Service(ngeoDebounce, ngeoLocation, ngeoStateManager) {
    this.manager_;
  ...
  _proto.initialStateToCamera_ = function initialStateToCamera_() {
    ...
    var lon = stateManager.getInitialNumberValue(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.LON);
    var lat = stateManager.getInitialNumberValue(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.LAT);
    var elevation = stateManager.getInitialNumberValue(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.ELEVATION);
    var heading = stateManager.getInitialNumberValue(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.HEADING) || 0;
    var pitch = stateManager.getInitialNumberValue(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.PITCH) || 0;
    goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(lon !== undefined);
    goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(lat !== undefined);
    goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(elevation !== undefined);
  ...
  _proto.cameraToState_ = function cameraToState_() {
    ...
    camera.moveEnd.addEventListener(this.ngeoDebounce_(function () {
      ...
      _this2.ngeoStateManager_.updateState((_this2$ngeoStateManag = {}, _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.ENABLED] = true, _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.LON] = Cesium.Math.toDegrees(position.longitude).toFixed(5), _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.LAT] = Cesium.Math.toDegrees(position.latitude).toFixed(5), _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.ELEVATION] = position.height.toFixed(0), _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.HEADING] = Cesium.Math.toDegrees(camera.heading).toFixed(3), _this2$ngeoStateManag[ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.PITCH] = Cesium.Math.toDegrees(camera.pitch).toFixed(3), _this2$ngeoStateManag));
    }, 1000, true));
  ...
  _proto.remove3dState_ = function remove3dState_() {
    ...
    this.ngeoLocation_.getParamKeysWithPrefix(ngeo_olcs_constants_js__WEBPACK_IMPORTED_MODULE_3__["default"].Permalink3dParam.PREFIX).forEach(function (key) {
...
var name = 'ngeoOlcsService';
Service.module = angular.module(name, [ngeo_misc_debounce_js__WEBPACK_IMPORTED_MODULE_1__["default"].name, ngeo_statemanager_Location_js__WEBPACK_IMPORTED_MODULE_2__["default"].module.name, ngeo_statemanager_Service_js__WEBPACK_IMPORTED_MODULE_4__["default"].module.name]).service(name, Service);
var exports = Service;
/* harmony default export */ __webpack_exports__["default"] = (exports);
...
var exports = angular.module('ngeoOlcsControls3d', []);
...
var Controller = function () {
  ...
  _proto.$onInit = function $onInit() {
    ...
    if (!this.ol3dm) {
      this.ol3dm = goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(this.olcsService_.getManager());
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ngeo_olcs_Service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngeo/olcs/Service.js */ "./src/olcs/Service.js");
/* harmony import */ var ngeo_olcs_controls3d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngeo/olcs/controls3d.js */ "./src/olcs/controls3d.js");


var m = angular.module('ngeoOlcsModule', [ngeo_olcs_controls3d_js__WEBPACK_IMPORTED_MODULE_1__["default"].name, ngeo_olcs_Service_js__WEBPACK_IMPORTED_MODULE_0__["default"].module.name]);
var exports = m;
/* harmony default export */ __webpack_exports__["default"] = (exports);
