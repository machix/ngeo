...
/* harmony import */ var ngeo_message_displaywindowComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngeo/message/displaywindowComponent.js */ "./src/message/displaywindowComponent.js");
var exports = {};


exports.module = angular.module('app', [ngeo_message_displaywindowComponent_js__WEBPACK_IMPORTED_MODULE_1__["default"].name]);
...
var exports = angular.module('ngeoMessageDisplaywindowComponent', ['ngSanitize']);
...
exports.value('ngeoMessageDisplaywindowTemplateUrl', function ($attrs) {
...
exports.Controller_ = function () {
  _class.$inject = ["$element", "$sce", "$scope", "$compile"];

  function _class($element, $sce, $scope, $compile) {
    this.clearOnClose;
    this.content = null;
  ...
  _proto.$onInit = function $onInit() {
    ...
    if (this.contentTemplate) {
      var scope = goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(this.contentScope || this.scope_);
      var compiled = this.compile_(this.contentTemplate)(scope);
      var displayWindow = this.element_.find('.ngeo-displaywindow .windowcontainer .animation-container');
