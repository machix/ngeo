...
/* harmony import */ var ol_style_Circle_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ol/style/Circle.js */ "./node_modules/ol/style/Circle.js");
...
/* harmony import */ var ngeo_geolocation_mobile_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngeo/geolocation/mobile.js */ "./src/geolocation/mobile.js");
var exports = {};
...
var appmodule = angular.module('app', ['gettext', ngeo_geolocation_mobile_js__WEBPACK_IMPORTED_MODULE_10__["default"].name, ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_9__["default"].name]);

exports.MainController = function ($scope, ngeoFeatureOverlayMgr) {
  var positionFeatureStyle = new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
    image: new ol_style_Circle_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
      radius: 6,
  ...
  var accuracyFeatureStyle = new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
    fill: new ol_style_Fill_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
...
exports.MainController.$inject = ["$scope", "ngeoFeatureOverlayMgr"];
...
var exports = angular.module('ngeoMobileGeolocation', [ngeo_map_FeatureOverlayMgr_js__WEBPACK_IMPORTED_MODULE_1__["default"].module.name, ngeo_message_Notification_js__WEBPACK_IMPORTED_MODULE_2__["default"].module.name]);
...
exports.Controller_ = function ($scope, $element, gettextCatalog, ngeoFeatureOverlayMgr, ngeoNotification) {
  var _this = this;

  $element.on('click', this.toggleTracking.bind(this));
  var map = $scope['getMobileMapFn']();
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assertInstanceof(map, ol_Map_js__WEBPACK_IMPORTED_MODULE_7__["default"]);
  this.$scope_ = $scope;
  this.map_ = map;
  var options = $scope['getMobileGeolocationOptionsFn']() || {};
  goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assertObject(options);
...
exports.Controller_.$inject = ["$scope", "$element", "gettextCatalog", "ngeoFeatureOverlayMgr", "ngeoNotification"];
...
exports.Controller_.prototype.toggleTracking = function () {
  if (this.geolocation_.getTracking()) {
    ...
    goog_asserts_js__WEBPACK_IMPORTED_MODULE_0__["default"].assert(currentPosition !== undefined);
...
exports.Controller_.prototype.autorotateListener = function () {
  ...
  if (window.hasOwnProperty('ondeviceorientationabsolute')) {
    window.addEventListener('deviceorientationabsolute', function (evt) {
      currentAlpha = _this2.handleRotate_(evt.alpha, currentAlpha);
    }, true);
...
exports.controller('ngeoGeolocationMobileController', exports.Controller_);
/* harmony default export */ __webpack_exports__["default"] = (exports);
