...
/* harmony import */ var ngeo_format_XSDAttribute_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngeo/format/XSDAttribute.js */ "./src/format/XSDAttribute.js");
...
exports.module = angular.module('app', ['gettext', ngeo_map_module_js__WEBPACK_IMPORTED_MODULE_3__["default"].name, ngeo_editing_attributesComponent_js__WEBPACK_IMPORTED_MODULE_1__["default"].name]);
...
exports.MainController = function ($http, $timeout, $scope) {
  ...
  this.disabled = false;
  this.feature = new ol_Feature_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
    'name': 'A feature',
    'kind': 'house'
  });
...
exports.MainController.$inject = ["$http", "$timeout", "$scope"];

exports.MainController.prototype.handleXSDAttributeGet_ = function (resp) {
  var format = new ngeo_format_XSDAttribute_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
