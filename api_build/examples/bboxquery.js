...
/* harmony import */ var _bboxquery_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bboxquery.css */ "./examples/bboxquery.css");
/* harmony import */ var _bboxquery_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_bboxquery_css__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var ngeo_query_module_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngeo/query/module.js */ "./src/query/module.js");
...
exports.MainController = function ($scope, ngeoDataSources) {
  ...
  var informationLayer = new ol_layer_Image_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
    'source': new ol_source_ImageWMS_js__WEBPACK_IMPORTED_MODULE_12__["default"]({
  ...
  var busStopLayer = new ol_layer_Image_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
    'source': new ol_source_ImageWMS_js__WEBPACK_IMPORTED_MODULE_12__["default"]({
      'url': _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].MAPSERVER_PROXY,
      params: {
        'LAYERS': 'bus_stop'
  ...
  ngeoDataSources.collection.push(new ngeo_datasource_OGC_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
    ...
    name: 'bus_stop',
    visible: true,
    wfsFeatureNS: _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].MAPSERVER_WFS_FEATURE_NS,
    wfsUrl: _url_js__WEBPACK_IMPORTED_MODULE_0__["default"].MAPSERVER_PROXY,
    ogcLayers: [{
      name: 'bus_stop',
      queryable: true
    }]
...
exports.MainController.$inject = ["$scope", "ngeoDataSources"];
